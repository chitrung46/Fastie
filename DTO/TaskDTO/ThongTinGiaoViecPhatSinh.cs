...
{
    public class ThongTinGiaoViecPhatSinh
    {
        private string ten;
        private string moTa;
        ...
        public ThongTinGiaoViecPhatSinh()
        {
        }

        public ThongTinGiaoViecPhatSinh(string ten, string moTa, string thoiHanHoanThanh, string idTaiKhoanGiaoViec, string idBoPhanGiaoViec, string danhSachTaiKhoanNhanViec, string danhSachBoPhanNhanViec, string danhSachHinhAnh, string danhSachTaiLieu, string idCongViecGoc)
        {
            this.ten = ten;
            this.moTa = moTa;
