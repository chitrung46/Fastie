...
namespace DTO.Task
{
    public class TaskWithPersonel
    {
        ...
        public TaskWithPersonel(string congViecID, string tenCongViec, string moTaCongViec, DateTime? thoiGianGiaoViec, DateTime? thoiGianHoanThanh, DateTime? thoiHanHoanThanh,
                                string ghiChu, string idTaiKhoanGiaoViec, string idBoPhanGiaoViec, string idLoaiCongViec, string idTienDoCongViec, string idLichSuMacDinh, string tenNhanSuGiaoViec, string tenBoPhan, string tenLoaiCongViec, string tenTienDoCongViec)
        {
        ...
        public TaskWithPersonel() { }

        public string CongViecID { get => congViecID; set => congViecID = value; }
        ...
        public string TenTienDoCongViec { get => tenTienDoCongViec; set => tenLoaiCongViec = value;}
    }
}
